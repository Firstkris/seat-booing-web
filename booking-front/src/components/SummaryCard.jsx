...
function SummaryCard({ seatInfo = false, setIsSelect }) {
    ...
    const departureDate = new Date(selectSchedule.departureDate).toLocaleString(
        'th-TH',
        options
    );
    const departTime = new Date(selectSchedule.departTime).toLocaleTimeString(
        [],
                        ...
                        <div className='flex flex-col text-left'>
                            ...
                            <div>
                                {selectSeatCode.map((el) => (
                                    <span
                                        className='text-xl text-secondary font-semibold pr-2'
                                        key={el}
                                    >
                                        {' '}
                                        {el}
